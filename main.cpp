...
void InteractionInitialisation()
{
	...
	multi_reciv = new multicast_net("224.10.12.78", 10001);      // Object do odbioru ramek sieciowych
	multi_send = new multicast_net("224.10.12.78", 10001);       // Object do wysy³ania ramek
	...
	int       nCmdShow)
{
	...
	main_window = CreateWindow(class_name, "WZR 2020/21, temat 4, wersja c [Y-autopilot, F11-test autop.]", WS_OVERLAPPEDWINDOW | WS_VISIBLE | WS_CLIPCHILDREN | WS_CLIPSIBLINGS,
		50, 100, 1000, 900, NULL, NULL, hInstance, NULL);
