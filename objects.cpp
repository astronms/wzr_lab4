...
MovableObject::MovableObject(Terrain *t)             // konstruktor                   
{
	...
	state.vPos = Vector3(-828.711792, 226.856354, 661.495728);
	state.qOrient = quaternion(0.012106, 0.995875, -0.067772, -0.059045);
...
void Terrain::DrawObject()
{
	...
	GLfloat GreenSurface[] = { 0.05f, 0.82f, 0.2f, 1.0f };
